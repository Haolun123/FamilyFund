...
- **黄金矩阵策略失效，建议固定定投**（2026-05-12）：回测验证（原始矩阵+对冲矩阵）两套均在2024年结构性牛市中失效。黄金价格由去美元化/央行购金等宏观结构性因素驱动，PE×VIX 和 MA200乖离率等技术指标均无法有效捕捉，矩阵择时反而导致踏空。详见 `DESIGN_BACKTEST.md` 第十六节。
